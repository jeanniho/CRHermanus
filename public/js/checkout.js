...
if (country_name) {
  ...
  axios(options).then(function (res) {
    ...
    var country_count = 0;
    countries.forEach(function (country_object) {
      var name = country_object.name;

      if (country_count = 0) {
        country_name.innerHTML += "<option value=\"".concat(name, "\" selected>\n                ").concat(name, "</option>");
      } else {
        country_name.innerHTML += "<option value=\"".concat(name, "\">").concat(name, "</option>");
      }
