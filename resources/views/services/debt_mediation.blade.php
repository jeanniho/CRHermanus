...
<div class="container">
    <h1 class="text-center mt-3">
        <span class="bt_bb_headline_content"><span>
            <strong class="text-danger">Debt</strong> Mediation<br>
        </span></span>
    </h1>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-2">
            <h2 class="mb-3">
                <span class="bt_bb_headline_content"><span>
                    <strong class="text-danger">Debt Mediation</strong> Contact Form<br>
                </span></span>
            </h2>
            ...
            <div class="col bg-light">
                ...
                @endif
                <form action="{{ route('debt_mediation') }}" method="POST">
                    {{ csrf_field() }}
                    <h4 class="text-center font-weight-bold text-danger">Contact Form</h4>
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="service_type" placeholder="Your full name *" name="service_type" value="debt_mediation" required>
                    </div>
                    <div class="form-group">
    ...
    <div class="mt-3 mb-5">
        <p>
            The act (NCA 34 of 2005) provides a legislated remedy for over-indebted consumers (viz Debt Review). An alternative to Debt Review is a voluntary payment arrangement to pay their accounts. <br><br>
            The effectiveness of Debt Mediation is when it is managed on a controlled basis. It is the responsibility of all Credit Providers who adhere to Section 86 (5)(a) of the act to act in good faith in the Debt Review Process all negotiations should be designed to result in a responsible debt re-arrangement plan for their client.<br><br>
            The current management of Credit Rescue has been involved with debt restructuring for over 14 years, 11 years with Bill Tolken Hendrickse & Ass (t/a Power Rescue) and the past 3 years using Debt Counselors viz, S. Olkers, A Carstens and R. Sedick. Credit Rescue has consistently built up a reservoir of practical and theoretical knowledge of the (Debt Management) industry.
        </p>
    </div>
